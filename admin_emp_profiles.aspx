...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            InsertCommand="INSERT INTO [Company] ([company_name], [username], [que_id], [ansr], [contact_person], [company_contact], [company_addrs], [company_email], [company_details]) VALUES (@company_name, @username, @que_id, @ansr, @contact_person, @company_contact, @company_addrs, @company_email, @company_details)" SelectCommand="SELECT * FROM [Company]" 
