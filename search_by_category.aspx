    ...
    <p>
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="DropDownList1_SelectedIndexChanged" DataTextField="category_name" DataValueField="category_id">
                    </asp:DropDownList>
                    &nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    &nbsp;&nbsp;
                    <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" DataTextField="area_name" DataValueField="category_id">
                    </asp:DropDownList>
                    &nbsp;</td>
            </tr>
            <tr>
        ...
        <asp:GridView ID="GridView1" runat="server" style="margin-left: 11px" 
                        onselectedindexchanged="GridView1_SelectedIndexChanged"  AutoGenerateColumns="False" DataSourceID="adsearch">
            <Columns>
                 ...
                 <asp:BoundField DataField="start_date" HeaderText="starting date" />
                  <asp:BoundField DataField="end_date" HeaderText="Ending date" />
                   <asp:BoundField DataField="expr_req" HeaderText="Experience" />
                    ...
                    <asp:SqlDataSource ID="adsearch" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT FROM Company INNER JOIN Company_package ON Company.company_id = Company_package.company_id"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 192px">
