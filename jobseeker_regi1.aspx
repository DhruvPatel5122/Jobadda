        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="View1" runat="server">
                ...
                <table frame="void" 
                    ...
                    <tr>
                        <td align="right" style="width: 403px">
                            <asp:Label ID="Label2" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 403px">
                            <asp:Label ID="Label3" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 403px">
                            <asp:Label ID="Label4" runat="server" class="lab" 
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label6" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label7" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label8" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label9" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label10" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label16" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label15" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label11" runat="server" class="lab" 
                                Text="Contact no."></asp:Label>
                        </td>
                        <td>
                            &nbsp;&nbsp;
                            <asp:TextBox ID="TextBox9" runat="server" TextMode="SingleLine" MinLength="10" MaxLength="10"></asp:TextBox>
                            &nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label12" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 405px">
                            <asp:Label ID="Label51" runat="server" class="lab" 
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label23" runat="server" class="lab" 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="DropDownList6" runat="server">
                                ...
                                <asp:ListItem Value="1">B.C.A</asp:ListItem>
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label26" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label27" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label28" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label29" runat="server" class="lab" 
                                Text="Institute"></asp:Label>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label30" runat="server" class="lab" 
                                Text="Percentage"></asp:Label>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label31" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label32" runat="server" class="lab" 
                                Text="Institute"></asp:Label>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label33" runat="server" class="lab" 
                                Text="Percentage"></asp:Label>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 406px">
                            <asp:Label ID="Label34" runat="server" class="lab" 
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td align="right" style="width: 412px">
                            <asp:Label ID="Label36" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 412px">
                            <asp:Label ID="Label37" runat="server" class="lab" 
                                Text="Area"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td align="right" style="width: 412px">
                            <asp:Label ID="Label38" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 412px">
                            <asp:Label ID="Label39" runat="server" class="lab" 
                                Text="Role"></asp:Label>
                        </td>
                        <td>
                            &nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 412px">
                            <asp:Label ID="Label40" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 412px">
                            <asp:Label ID="Label43" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 412px">
                            <asp:Label ID="Label46" runat="server" class="lab" 
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td align="right" style="width: 418px">
                            <asp:Label ID="Label48" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 418px">
                            <asp:Label ID="Label49" runat="server" class="lab" 
                    ...
                    <tr>
                        <td align="right" style="width: 418px">
                            <asp:Label ID="Label52" runat="server" class="lab" 
                                Text="1 "></asp:Label>
                        </td>
                        <td>
  ...
  objXmlHttpRequest.send(null);
                    ...
                    <tr>
                        <td align="right" style="width: 418px; height: 30px;">
                            <asp:Label ID="Label53" runat="server" class="lab" 
                                Text="2"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td align="right" style="width: 418px">
                            <asp:Label ID="Label54" runat="server" class="lab" 
                                Text="3"></asp:Label>
                        </td>
                        <td>
                            &nbsp;&nbsp;
                    ...
                    <tr>
                        <td align="right" style="width: 418px">
                            <asp:Label ID="Label50" runat="server" class="lab" 
