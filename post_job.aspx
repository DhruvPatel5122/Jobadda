...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        ...
        &nbsp;<table style="width: 100%">
            ...
            <tr>
                <td align="right" style="width: 400px">
                    <asp:Label ID="Label5" runat="server" class="lab"
                        Text="Area"></asp:Label>
                </td>
                <td>
                    &nbsp;&nbsp;
            ...
            <tr>
                <td align="right" style="width: 400px">
                    <asp:Label ID="Label13" runat="server" class="lab"
                        Text="Date"></asp:Label>
                </td>
                <td>
                    &nbsp;&nbsp;
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="Button1" runat="server" BackColor="#877361" 
                        ...
                        Width="54px" onclick="Button1_Click" script="javascript" type = "text/javascript" 
